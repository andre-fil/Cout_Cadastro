...
?>
            <?php foreach($pessoas as $pessoa): ?>
              ...
              <tr onclick="window.location='exibirCliente.php?cpf=<?php echo $pessoa->cpf(); ?>';" style="cursor:pointer;">
