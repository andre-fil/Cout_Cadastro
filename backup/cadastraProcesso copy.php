...
if ($dadosProcesso !== null) {
    ...
    list($cpf, $protocolo, $parceiro,$descricao) = $dadosProcesso;

    $processo = new Processo($cpf,$protocolo,$parceiro,$descricao);
   ...
   // Verificar se já existe um processo com o mesmo protocolo
    ...
    if ($numLinhas > 0) {
        ...
        $sqlInsert = "INSERT INTO Processo (cpf, protocolo, parceiro,descricao) VALUES (:cpf, :protocolo, :parceiro,:descricao)";
